...
Second, we don't have any variation on the dependent variable, both Italy and China have a high death tolls.^[What counts as low is a moving target because the original piece predicted only 500 for the U.S. and said it wasn't likely to reach the high numebr of China's because China had more smokers. Now Italy's high death count is the new high. But he forcasts 5,000 for the U.S. would would then be the new high. But this is contrast to the NYT estimate of a million, so maybe these are all really low. The joys of vague theory. ¯\_(ツ)_/¯] The sample does not include any examples of low death toll countries for us to infer from.
