...
[ROUGH DRAFT, PLEASE DO NOT CIRCULATE. COMMENTS WELCOME!]
 ...
 ^[Acknowledgments: I thank a good chunk of the NYU Law Class of 2013 for suggesting the subject of this review.]
...
Hospitilization rates of quarter of known cases in early U.S. CDC data of [25%](https://www.independent.co.uk/news/world/americas/coronavirus-new-york-hospital-cases-today-map-decrease-covid-19-a9425111.html), and currently [12% in New York](https://www.independent.co.uk/news/world/americas/coronavirus-new-york-hospital-cases-today-map-decrease-covid-19-a9425111.html)
...
All together, this would point out that the proposed policy of sheltering in place only older Americans  wouldn't even remove half of the current burden on the healthcare system, much less when most adults under 60 are contracting the disease together at about the same time.
...
Natural selection will remove weaker humans (*SUSCEPTIBLE_POP*)
...
$\partial DEATHS_t =F(CHINA_INFLECTION, ADAPTATION,WEAKENING,SUSCEPTIBLE_POP,SEASONALITY, Time)$
...
Second, we don't have any variation on the dependent variable, both Italy and China have a high death tolls. The sample does not include any examples of low death toll countries for us to infer from.
...
Italy's death toll might surpass China soon but China also proves it should stop soon.
