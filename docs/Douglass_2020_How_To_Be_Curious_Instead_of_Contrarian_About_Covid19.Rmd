...
**Rex W. Douglass PhD** ^[If you found this note useful, please consider donating a few minutes to contribute examples of government COVID-19 quarantine measures to the [TIGR Project](https://github.com/rexdouglass/TIGR)] 
 ^[Director of the Machine Learning for Social Science Lab, Center for Peace and Security Studies, University of California San Diego]
...
p_combined <- countries_long %>% filter(country %in% "US") %>%
      ...
      geom_vline(xintercept=ymd("2020-09-01") , linetype = "dashed", col="black") +
      annotate("text", x = ymd("2020-09-01")-4, y = 150000, label = "Value at this date is what we want to know", color="black", size=5, angle=90) +
...
```{r, echo=F, message=FALSE, results =T, warning=FALSE, fig.width=6, fig.height=13}
