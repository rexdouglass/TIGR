...
Serial interval of 3.96 days with standard deviatoin of 4.75 days, taken from a recent literature review ([Du et al. March 20, 2020](https://www.medrxiv.org/content/10.1101/2020.02.19.20025452v4)).
...
r_df %>% filter(!is.na(pop)) %>% pull(r_ml) %>% weighted.quantile(w=weights) #weight by country, exclude obs with no population data.
